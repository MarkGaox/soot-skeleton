...
public class AppTest {
    ...
    public void IFDSRunnerTest() throws IOException {
        ...
        App.main(new String[]{"-r", "src/test/resources/config/loadConfigIFDS.yaml", "result.yaml", "-rf"});
        System.out.println();
        System.out.println();
    }
    ...
    public void CGRunnerTest() throws IOException {
        ...
        App.main(new String[]{"-r", "src/test/resources/config/loadConfig.yaml", "result2.yaml", "-cg"});
        System.out.println();
        System.out.println();
    }
}
